...
public class MainOnScerllListener implements AbsListView.OnScrollListener {
    ...
    public MainOnScerllListener(View footer) {
        this.footer = footer;
    }
    ...
    private void loadMoreData() {
        ...
        httpUtils.send(HttpMethod.POST, Constant.URL_NEWS, params, new RequestCallBack<String>() {
            @Override
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                data = mainData.getDatas();
                LogUtil.i("MAINDATA", "MAINDATA====>>>" + mainData.toString());
            }
