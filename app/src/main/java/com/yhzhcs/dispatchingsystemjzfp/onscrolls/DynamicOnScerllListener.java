...
public class DynamicOnScerllListener implements AbsListView.OnScrollListener {
    ...
    //数据
    private List<Dtlist> data;

    public DynamicOnScerllListener(View footer) {
        this.footer = footer;
    }
    ...
    private void loadMoreData() {
        ...
        httpUtils.send(HttpMethod.GET, Constant.URL_NEWS_INFORMATION, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                data = informationBean.getDtList();
            }
...
//            spinner.setVisibility(View.GONE);
    ...
    public interface OnloadDataListener {
        void onLoadData(List<Dtlist> data);
    }
}
