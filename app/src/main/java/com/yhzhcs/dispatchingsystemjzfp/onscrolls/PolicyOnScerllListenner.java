...
public class PolicyOnScerllListenner implements AbsListView.OnScrollListener {
    ...
    //数据
    private List<Zclist> data;

    public PolicyOnScerllListenner(View footer) {
        this.footer = footer;
    }
    ...
    private void loadMoreData() {
        ...
        httpUtils.send(HttpMethod.GET, Constant.URL_NEWS_INFORMATION, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                data = informationBean.getZcList();
            }
...
//            spinner.setVisibility(View.GONE);
    ...
    public interface OnloadDataListener {
        void onLoadData(List<Zclist> data);
    }
}
